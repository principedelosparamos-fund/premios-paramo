...
export default function ReportesCalificaciones() {
  ...
  if (loading) return <p className="text-center py-10">Cargando calificaciones...</p>;
  if (votaciones.length === 0) return <p className="text-center py-10">No hay calificaciones registradas.</p>;

  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <h2 className="text-2xl font-bold text-gold-600 text-center">Reporte de Calificaciones de Jurados</h2>
